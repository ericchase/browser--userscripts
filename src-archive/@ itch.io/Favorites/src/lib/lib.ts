...
// prettier-ignore
const HTMLElementTagNameSet: Set<keyof HTMLElementTagNameMap> = new Set([
  'a',
  'abbr',
  'address',
  'area',
...
// prettier-ignore
const SVGElementTagNameSet: Set<keyof SVGElementTagNameMap> = new Set([
  'a',
  'animate',
  'animateMotion',
  'animateTransform',
...
// prettier-ignore
const MathMLElementTagNameSet: Set<keyof MathMLElementTagNameMap> = new Set([
  'annotation',
  'annotation-xml',
  'maction',
  'math',
...
export function $<K extends keyof MathMLElementTagNameMap, V extends MathMLElementTagNameMap[K]>(tagName: K, selector: string, root?: { querySelector: Function }): V;
export function $(
...
export function $$<K extends keyof HTMLElementTagNameMap, V extends HTMLElementTagNameMap[K]>(tagName: K, selector: string, root?: { querySelectorAll: QuerySelectorAllFn<K, V> }): V[];
export function $$<K extends keyof SVGElementTagNameMap, V extends SVGElementTagNameMap[K]>(tagName: K, selector: string, root?: { querySelectorAll: QuerySelectorAllFn<K, V> }): V[];
export function $$<K extends keyof MathMLElementTagNameMap, V extends MathMLElementTagNameMap[K]>(tagName: K, selector: string, root?: { querySelectorAll: QuerySelectorAllFn<K, V> }): V[];
export function $$(
  tagName: keyof HTMLElementTagNameMap | keyof SVGElementTagNameMap | keyof MathMLElementTagNameMap, //
  selector: string,
...
export function $$WithRoot<K extends keyof HTMLElementTagNameMap, V extends HTMLElementTagNameMap[K]>(tagName: K, selector: string, root?: { querySelectorAll: QuerySelectorAllFn<K, V> }): V[];
export function $$WithRoot<K extends keyof SVGElementTagNameMap, V extends SVGElementTagNameMap[K]>(tagName: K, selector: string, root?: { querySelectorAll: QuerySelectorAllFn<K, V> }): V[];
export function $$WithRoot<K extends keyof MathMLElementTagNameMap, V extends MathMLElementTagNameMap[K]>(tagName: K, selector: string, root?: { querySelectorAll: QuerySelectorAllFn<K, V> }): V[];
...
export function querySelectorAllWithRoot<K extends keyof HTMLElementTagNameMap, V extends HTMLElementTagNameMap[K]>(selector: K, root: { matches?: MatchFn; querySelectorAll: QuerySelectorAllFn<K, V> }): V[];
export function querySelectorAllWithRoot<K extends keyof SVGElementTagNameMap, V extends SVGElementTagNameMap[K]>(selector: K, root: { matches?: MatchFn; querySelectorAll: QuerySelectorAllFn<K, V> }): V[];
export function querySelectorAllWithRoot<K extends keyof MathMLElementTagNameMap, V extends MathMLElementTagNameMap[K]>(selector: K, root: { matches?: MatchFn; querySelectorAll: QuerySelectorAllFn<K, V> }): V[];
...
export function matches<K extends keyof HTMLElementTagNameMap, V extends HTMLElementTagNameMap[K]>(tagName: K, selector: string, element: { matches: MatchFn }): element is V;
export function matches<K extends keyof SVGElementTagNameMap, V extends SVGElementTagNameMap[K]>(tagName: K, selector: string, element: { matches: MatchFn }): element is V;
export function matches<K extends keyof MathMLElementTagNameMap, V extends MathMLElementTagNameMap[K]>(tagName: K, selector: string, element: { matches: MatchFn }): element is V;
